...
def main():
    ...
    logging.info(f"Greedy plan constructed with score: {greedy_metrics['total_score']:.3f}")
    ...
    logging.info(f"Random plan constructed with score: {random_metrics['total_score']:.3f}")

    # 3. Refined Plan
    logging.info(f"Executing Refinement Phase: Local Search (Max Iterations: {args.iterations})...")
    ...
    logging.info(f"Refined plan optimized with score: {refined_metrics['total_score']:.3f}")
